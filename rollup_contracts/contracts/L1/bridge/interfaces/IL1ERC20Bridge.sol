...
interface IL1ERC20Bridge {
     ...
     */
    event DepositERC20(
        address l1token, address l2token, address indexed from, address indexed to, uint256 amount, bytes data
    );
     ...
     * @param data_; none
     */
    function deposit(address token_, address to_, uint256 amount_, uint256 gasLimit_, bytes memory data_)
        external
        payable;
